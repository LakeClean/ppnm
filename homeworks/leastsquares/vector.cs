...
public static void random(vector v){
	var rnd = new System.Random();
	for(int i=0; i<v.size; i++) v[i]= rnd.Next(101);
}

// Generate unit vector: unit_vector(n=size,i=direction)
public static vector unit_vector(int n, int i){
